...
export class ProductsComponent implements OnInit {
  ...
  cards = [
    ...
    { imgSrc: 'assets/images/oils/o1.JPG', title: 'Hair Oil - 100ml', description: ' Control hair fall |Reduce dandruff |No heating applied \n11 different types of herbs naturally infused by cold pressed method in COIO Cold Pressed Coconut Oil.\nHelps hair fall and dandruff control \n✅ Organic \n✅ Natural \n✅ Vegan \n❌ Chemicals \n❌ Preservatives \n❌ Artificial additives', dataName: 'Oils' },
    { imgSrc: 'assets/images/oils/o2.jpg', title: 'Cold Pressed Oil - 200ml', description: 'Cold pressed |No preservatives added |All purpose oil|Healthy \nCold pressed Homemade Coconut oil, made from a special Banavali species of Coconut. \n First by Segregation of best coconuts.\nHelps hair fall and dandruff control \n Sun Drying for high oil extraction.\n Coconuts are then put in Cold press machine to extract best water like looking oil.', dataName: 'Oils' },
    { imgSrc: 'assets/images/oils/o3.jpg', title: 'Cold Pressed Oil - 500ml', description: 'Cold pressed |No preservatives added |All purpose oil|Healthy \nCold pressed Homemade Coconut oil, made from a special Banavali species of Coconut. \n First by Segregation of best coconuts. \n Sun Drying for high oil extraction.\n Coconuts are then put in Cold press machine to extract best water like looking oil.', dataName: 'Oils' },
    { imgSrc: 'assets/images/lamps/l3.jpg', title: 'Coconut Shell Lamp', description: ' Perfect for Romantic Dinner | Dim-light Relaxation | Gifting | Unique Festival Decoration Coconut Soap Case / Planter Perfect soap holder for your bathroom | unique decor item |Can be used as both planter/soap holder Made from actual  natural coconut shell Can be used as both planter/soap holder\n✅ Organic\n✅ Eco-Friendly\n✅ Sustainable \n❌ Artificial Chemicals', dataName: 'Lamps' },
