...
export class ProductsComponent implements OnInit {
  ...
  cards = [
    ...
    { imgSrc: 'assets/images/oils/o7.jpg', title: 'Cold Pressed Sunflower Oil \u2022 500ml', description: 'No chemicals |No preservatives | Cooking oil| Made from dry sunflower seeds. \n Best seeds are Sun Dried for high oil extraction.\n Seeds are Cold pressed in wooden press to extract best oil.', dataName: 'Oils' },
