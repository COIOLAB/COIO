...
export class ProductsComponent implements OnInit {
  ...
  cards = [
    ...
    { imgSrc: 'assets/images/hampers/20240810_192603.jpg', title: 'Premium Hamper', description: 'Discover the perfect gift box that combines elegance and functionality, featuring a handcrafted coconut bowl, a stylish lamp, a soothing candle, and a beautifully hand-embroidered hand towel. 
Each item reflects quality craftsmanship and a commitment to sustainability, ensuring that your gift is both unique and environmentally friendly. Ideal for birthdays, anniversaries, or special celebrations, this box elevates the gifting experience
.. \n✅ Healthy \n✅ Actual ingredient Additions\n❌ No Artificial Colors \n❌ No Chemicals \n❌ No paraben and SLS ', dataName: 'Hamper' },
    { imgSrc: 'assets/images/hampers/h5.jpg', title: 'Mini Hamper', description: ' COIO Handcrafted Gift Solutions is here for you.. \n✅ Healthy \n✅ Actual ingredient Additions \n❌ No Artificial Colors \n❌ No Chemicals \n❌ No paraben and SLS', dataName: 'Hamper' },
    { imgSrc: 'assets/images/hampers/Soap Combo.jpg', title: 'Soap Combo', description: 'COIO Handmade Soap Combo handcraft soaps with care to ensure your loved ones feel pampered for birthdays, anniversaries, or special celebrations.. \n✅ Healthy \n✅ Actual ingredient Additions \n❌ No Artificial Colors \n❌ No Chemicals \n❌ No paraben and SLS', dataName: 'Hamper' },
    { imgSrc: 'assets/images/hampers/Hair Oil Combo.jpg', title: 'Hair Oil Combo', description: 'COIO Haircare Combo features a delightful handmade soap and a natural cold-pressed hair oil, complemented by a coconut handcrafted soap case.. \n✅ Healthy \n✅ Actual ingredient Additions \n❌ No Artificial Colors \n❌ No Chemicals \n❌ No paraben and SLS', dataName: 'Hamper' },
