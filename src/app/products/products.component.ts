...
export class ProductsComponent implements OnInit {
  ...
  cards = [
    ...
    { imgSrc: 'assets/images/oils/o6.jpg', title: 'Cold Pressed Groundnut Oil \u2022 500ml', description: 'Cold pressed |No preservatives added | Cooking oil| Made dry groundnut seeds. \n Best groundnuts are Sun Dried for high oil extraction.\n Dry nuts are Cold pressed in wooden press to extract best oil.', dataName: 'Oils' },
    { imgSrc: 'assets/images/oils/o5.jpg', title: 'Cold Pressed Coconut Oil \u2022 500ml', description: 'Cold pressed |No preservatives added | Cooking oil| Massage oil| Made from a special Banavali species of Coconut. \n Best coconuts are Sun Dried for high oil extraction.\n Dry copra is Cold pressed in wooden press to extract best oil.', dataName: 'Oils' },
